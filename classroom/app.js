            ...
            +'<div class="container-classroom" style="background-image: url('+"'"+'../images/bg-01.jpg'+"'"+');">'
              +'<div class="course-container p-3" >'
                +'<div class="row">'
                  ...
                  +'</div>'
                +'</div>'
                +'<div class="row p-t-15 p-b-30" id="course-container" style="max-height:540px; overflow:scroll">'
                +'</div>'
              +'</div>'
            +'</div>'
          +'</div>'
          +'<div class="col-12" style="padding-right: 0;">'
            +'<div class="container-classroom pt-0" style="background-image: url('+"'"+'../images/bg-01.jpg'+"'"+');">'
              +'<div class="course-container p-3" >'
                +'<div class="row">'
                  +'<div class="col text-left">'
                    +'<span class="login100-form-title p-b-10" style="text-align: left;">Classroom CourseWork</span>'
                  +'</div>'
                +'</div>'
